...
function WeatherContent() {
  ...
  if (loading) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center py-20 bg-[#F7FDF7] min-h-[50vh]">
  ...
  return (
    <div className="w-full min-h-full bg-[#F7FDF7] flex flex-col">
      {/* Header - Only visible on desktop or when navigation is needed */}
      <div className="flex items-center justify-between px-4 h-14 border-b border-gray-100 sticky top-0 bg-white z-40 md:z-50 flex-shrink-0">
        <button onClick={() => router.back()} className="p-1 text-gray-900 md:hidden">
          <ArrowLeft size={24} />
        </button>
        <h1 className="text-lg font-black text-gray-900">Weather Forecast</h1>
        ...
        <div className="max-w-screen-md mx-auto px-4 py-8">
          ...
          <div className="my-6 flex flex-col items-center">
            <img 
              ...
              className="w-32 h-32"
            />
            <h2 className="text-7xl font-black text-gray-900 tracking-tighter mt-2">{Math.round(weather.temperature)}°C</h2>
            <span className="text-xl font-bold text-[#2E7D32] mt-1 capitalize">{weather.description}</span>
          </div>
      ...
      <div className="px-4 mt-6">
        <div className="bg-[#FF5252] rounded-3xl p-6 text-white shadow-lg shadow-red-200">
      ...
      {weather.forecast && weather.forecast.length > 0 && (
        <div className="mt-8 px-4 pb-8">
          <h3 className="text-base font-black text-gray-900 mb-4 uppercase tracking-wider">Next 24 Hours</h3>
